...
static cl_command_buffer_khr _WRAPLIB_API_CALL clCreateCommandBufferKHR_error(cl_uint, const cl_command_queue *, const cl_command_buffer_properties_khr *, cl_int *) {
    return on_init_failed<cl_command_buffer_khr >(113);
}
...
static cl_int _WRAPLIB_API_CALL clFinalizeCommandBufferKHR_error(cl_command_buffer_khr) {
    return on_init_failed<cl_int >(114);
}
...
static cl_int _WRAPLIB_API_CALL clRetainCommandBufferKHR_error(cl_command_buffer_khr) {
    return on_init_failed<cl_int >(115);
}
...
static cl_int _WRAPLIB_API_CALL clCommandCopyBufferRectKHR_error(cl_command_buffer_khr, cl_command_queue, cl_mem, cl_mem, const size_t *, const size_t *, const size_t *, size_t, size_t, size_t, size_t, cl_uint, const cl_sync_point_khr *, cl_sync_point_khr *, cl_mutable_command_khr *) {
    return on_init_failed<cl_int >(120);
}
...
static cl_int _WRAPLIB_API_CALL clCommandCopyBufferToImageKHR_error(cl_command_buffer_khr, cl_command_queue, cl_mem, cl_mem, size_t, const size_t *, const size_t *, cl_uint, const cl_sync_point_khr *, cl_sync_point_khr *, cl_mutable_command_khr *) {
    return on_init_failed<cl_int >(121);
}
...
static cl_int _WRAPLIB_API_CALL clCommandCopyImageToBufferKHR_error(cl_command_buffer_khr, cl_command_queue, cl_mem, cl_mem, const size_t *, const size_t *, size_t, cl_uint, const cl_sync_point_khr *, cl_sync_point_khr *, cl_mutable_command_khr *) {
    return on_init_failed<cl_int >(123);
}
...
static cl_int _WRAPLIB_API_CALL clCommandFillImageKHR_error(cl_command_buffer_khr, cl_command_queue, cl_mem, const void *, const size_t *, const size_t *, cl_uint, const cl_sync_point_khr *, cl_sync_point_khr *, cl_mutable_command_khr *) {
    return on_init_failed<cl_int >(125);
}
...
static void _WRAPLIB_API_CALL clLogMessagesToSystemLogAPPLE_error(const char *, const void *, size_t, void *) {
    return on_init_failed<void >(129);
}
...
static void _WRAPLIB_API_CALL clLogMessagesToStdoutAPPLE_error(const char *, const void *, size_t, void *) {
    return on_init_failed<void >(130);
}
...
static void _WRAPLIB_API_CALL clLogMessagesToStderrAPPLE_error(const char *, const void *, size_t, void *) {
    return on_init_failed<void >(131);
}
...
static cl_program _WRAPLIB_API_CALL clCreateProgramWithILKHR_error(cl_context, const void *, size_t, cl_int *) {
    return on_init_failed<cl_program >(133);
}
...
static cl_command_queue _WRAPLIB_API_CALL clCreateCommandQueueWithPropertiesKHR_error(cl_context, cl_device_id, const cl_queue_properties_khr *, cl_int *) {
    return on_init_failed<cl_command_queue >(135);
}
...
static cl_int _WRAPLIB_API_CALL clEnqueueGenerateMipmapIMG_error(cl_command_queue, cl_mem, cl_mem, cl_mipmap_filter_mode_img, const size_t *, const size_t *, cl_uint, const cl_event *, cl_event *) {
    return on_init_failed<cl_int >(143);
}
...
static cl_int _WRAPLIB_API_CALL clGetKernelSubGroupInfoKHR_error(cl_kernel, cl_device_id, cl_kernel_sub_group_info, size_t, const void *, size_t, void *, size_t *) {
    return on_init_failed<cl_int >(144);
}
...
static cl_int _WRAPLIB_API_CALL clGetKernelSuggestedLocalWorkSizeKHR_error(cl_command_queue, cl_kernel, cl_uint, const size_t *, const size_t *, size_t *) {
    return on_init_failed<cl_int >(145);
}
...
static cl_int _WRAPLIB_API_CALL clEnqueueReleaseExternalMemObjectsKHR_error(cl_command_queue, cl_uint, const cl_mem *, cl_uint, const cl_event *, cl_event *) {
    return on_init_failed<cl_int >(147);
}
...
static cl_semaphore_khr _WRAPLIB_API_CALL clCreateSemaphoreWithPropertiesKHR_error(cl_context, const cl_semaphore_properties_khr *, cl_int *) {
    return on_init_failed<cl_semaphore_khr >(149);
}
...
static cl_mem _WRAPLIB_API_CALL clImportMemoryARM_error(cl_context, cl_mem_flags, const cl_import_properties_arm *, void *, size_t, cl_int *) {
    return on_init_failed<cl_mem >(155);
}
...
static void _WRAPLIB_API_CALL clSVMFreeARM_error(cl_context, void *) {
    return on_init_failed<void >(157);
}
...
static cl_int _WRAPLIB_API_CALL clSetKernelArgSVMPointerARM_error(cl_kernel, cl_uint, const void *) {
    return on_init_failed<cl_int >(163);
}
...
static cl_accelerator_intel _WRAPLIB_API_CALL clCreateAcceleratorINTEL_error(cl_context, cl_accelerator_type_intel, size_t, const void *, cl_int *) {
    return on_init_failed<cl_accelerator_intel >(165);
}
...
static void _WRAPLIB_API_CALL *clHostMemAllocINTEL_error(cl_context, const cl_mem_properties_intel *, size_t, cl_uint, cl_int *) {
    return on_init_failed<void *>(169);
}
...
static cl_int _WRAPLIB_API_CALL clEnqueueMigrateMemINTEL_error(cl_command_queue, const void *, size_t, cl_mem_migration_flags, cl_uint, const cl_event *, cl_event *) {
    return on_init_failed<cl_int >(179);
}
...
static cl_mem _WRAPLIB_API_CALL clCreateBufferWithPropertiesINTEL_error(cl_context, const cl_mem_properties_intel *, cl_mem_flags, size_t, void *, cl_int *) {
    return on_init_failed<cl_mem >(181);
}
...
static cl_mem _WRAPLIB_API_CALL clCreateBufferFromImageQCOM_error(cl_mem, cl_mem_flags, cl_int *) {
    return on_init_failed<cl_mem >(183);
}
...
static cl_int _WRAPLIB_API_CALL clSetPerfHintQCOM_error(cl_context, cl_perf_hint) {
    return on_init_failed<cl_int >(184);
}
...
static cl_mem _WRAPLIB_API_CALL clCreateFromEGLImageIMG_error(cl_context, cl_mem_flags, CLeglImageIMG, CLeglDisplayIMG, cl_int *) {
    return on_init_failed<cl_mem >(185);
}
...
static cl_recording_qcom _WRAPLIB_API_CALL clNewRecordingQCOM_error(cl_command_queue, cl_int *) {
    return on_init_failed<cl_recording_qcom >(186);
}
...
static cl_int _WRAPLIB_API_CALL clQueryMLInterfaceVersionsQCOM_init(cl_int *arg0, cl_int *arg1, cl_uint arg2, cl_uint *arg3) {
    load_library();
    return clQueryMLInterfaceVersionsQCOM(arg0, arg1, arg2, arg3);
}
static cl_int _WRAPLIB_API_CALL clQueryMLInterfaceVersionsQCOM_error(cl_int *, cl_int *, cl_uint, cl_uint *) {
    return on_init_failed<cl_int >(193);
}
static cl_int _WRAPLIB_API_CALL clGetMLInterfaceQCOM_init(void *arg0, cl_int arg1, cl_int arg2) {
    load_library();
    return clGetMLInterfaceQCOM(arg0, arg1, arg2);
}
static cl_int _WRAPLIB_API_CALL clGetMLInterfaceQCOM_error(void *, cl_int, cl_int) {
    return on_init_failed<cl_int >(194);
}
static constexpr size_t NR_FUNC = 195;
static void* g_func_table[NR_FUNC] = {(void*)(&clGetPlatformIDs_init),
    ...
    (void*)(&clQueryMLInterfaceVersionsQCOM_init),
    (void*)(&clGetMLInterfaceQCOM_init)};
static void* g_func_table_error[NR_FUNC] = {(void*)(&clGetPlatformIDs_error),
    ...
    (void*)(&clQueryMLInterfaceVersionsQCOM_error),
    (void*)(&clGetMLInterfaceQCOM_error)};
...
cl_int _WRAPLIB_API_CALL clQueryMLInterfaceVersionsQCOM(cl_int *arg0, cl_int *arg1, cl_uint arg2, cl_uint *arg3) {
    typedef cl_int (_WRAPLIB_API_CALL *f_ptr_t)(cl_int *, cl_int *, cl_uint, cl_uint *);
    ON_ENTRY(clQueryMLInterfaceVersionsQCOM);
    f_ptr_t f = (f_ptr_t)(g_func_table[193]);
    return f(arg0, arg1, arg2, arg3);
}
cl_int _WRAPLIB_API_CALL clGetMLInterfaceQCOM(void *arg0, cl_int arg1, cl_int arg2) {
    typedef cl_int (_WRAPLIB_API_CALL *f_ptr_t)(void *, cl_int, cl_int);
    ON_ENTRY(clGetMLInterfaceQCOM);
